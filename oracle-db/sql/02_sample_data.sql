...
INSERT INTO emp_master (employee_code, full_name, nic, dob, gender,
  ...
  VALUES ('ACME-1001','Rajiv Subramaniam','196512345V',DATE '1965-03-15','MALE',
    DATE '2010-01-01', DATE '2010-04-01', 'ACTIVE');

-- 1002 Priya Fernando — CHRO (join 2012-06-01, ~13 yrs)
INSERT INTO emp_master (employee_code, full_name, nic, dob, gender,
    join_date, confirmed_date, emp_status)
  VALUES ('ACME-1002','Priya Fernando','197834567V',DATE '1978-07-22','FEMALE',
    DATE '2012-06-01', DATE '2012-09-01', 'ACTIVE');

-- 1003 Kamal Perera — Sr Engineer (join 2018-02-01, ~7 yrs)
INSERT INTO emp_master (employee_code, full_name, nic, dob, gender,
    join_date, confirmed_date, emp_status)
  VALUES ('ACME-1003','Kamal Perera','198956789V',DATE '1989-09-12','MALE',
    DATE '2018-02-01', DATE '2018-05-01', 'ACTIVE');

-- 1004 Dilini Jayawardena — HR BP (join 2019-07-15, ~6 yrs)
INSERT INTO emp_master (employee_code, full_name, nic, dob, gender,
    join_date, confirmed_date, emp_status)
  VALUES ('ACME-1004','Dilini Jayawardena','199267890V',DATE '1992-05-30','FEMALE',
    DATE '2019-07-15', DATE '2019-10-15', 'ACTIVE');

-- 1005 Tharindu Silva — Engineer (join 2021-03-01, ~4 yrs)
INSERT INTO emp_master (employee_code, full_name, nic, dob, gender,
    join_date, confirmed_date, emp_status)
  VALUES ('ACME-1005','Tharindu Silva','199578901V',DATE '1995-01-20','MALE',
    DATE '2021-03-01', DATE '2021-06-01', 'ACTIVE');

-- 1006 Sanduni Rathnayake — Finance Analyst (join 2022-01-10, ~3 yrs)
INSERT INTO emp_master (employee_code, full_name, nic, dob, gender,
    join_date, confirmed_date, emp_status)
  VALUES ('ACME-1006','Sanduni Rathnayake','199689012V',DATE '1996-08-14','FEMALE',
    DATE '2022-01-10', DATE '2022-04-10', 'ACTIVE');

-- 1007 Amila Bandara — Ops Manager (join 2016-05-01, ~9 yrs)
INSERT INTO emp_master (employee_code, full_name, nic, dob, gender,
    join_date, confirmed_date, emp_status)
  VALUES ('ACME-1007','Amila Bandara','198590123V',DATE '1985-12-03','MALE',
    DATE '2016-05-01', DATE '2016-08-01', 'ACTIVE');

-- 1008 Chamath Kulatunga — Junior Dev (join 2025-01-15, PROBATION)
INSERT INTO emp_master (employee_code, full_name, nic, dob, gender,
    join_date, emp_status)
  VALUES ('ACME-1008','Chamath Kulatunga','200112345V',DATE '2001-06-10','MALE',
    DATE '2025-01-15', 'PROBATION');

-- 1009 Nethmi Wijesinghe — HR Coordinator (join 2023-02-01, ~2 yrs)
INSERT INTO emp_master (employee_code, full_name, nic, dob, gender,
    join_date, confirmed_date, emp_status)
  VALUES ('ACME-1009','Nethmi Wijesinghe','199923456V',DATE '1999-10-07','FEMALE',
    DATE '2023-02-01', DATE '2023-05-01', 'ACTIVE');

-- 1010 Ishara Mendis — Marketing Executive (join 2024-06-01, ~1 yr)
INSERT INTO emp_master (employee_code, full_name, nic, dob, gender,
    join_date, confirmed_date, emp_status)
  VALUES ('ACME-1010','Ishara Mendis','199801234V',DATE '1998-03-25','FEMALE',
    DATE '2024-06-01', DATE '2024-09-01', 'ACTIVE');
...
INSERT INTO emp_job (emp_id,dept_id,job_title,grade,employment_type,manager_emp_id,effective_date)
  VALUES (1001,1,'Chief Executive Officer','8','FULL_TIME_PERMANENT',NULL,DATE '2010-01-01');
INSERT INTO emp_job (emp_id,dept_id,job_title,grade,employment_type,manager_emp_id,effective_date)
  VALUES (1002,2,'Chief Human Resources Officer','7','FULL_TIME_PERMANENT',1001,DATE '2012-06-01');
INSERT INTO emp_job (emp_id,dept_id,job_title,grade,employment_type,manager_emp_id,effective_date)
  VALUES (1003,3,'Senior Software Engineer','5','FULL_TIME_PERMANENT',1001,DATE '2018-02-01');
INSERT INTO emp_job (emp_id,dept_id,job_title,grade,employment_type,manager_emp_id,effective_date)
  VALUES (1004,2,'HR Business Partner','4','FULL_TIME_PERMANENT',1002,DATE '2019-07-15');
INSERT INTO emp_job (emp_id,dept_id,job_title,grade,employment_type,manager_emp_id,effective_date)
  VALUES (1005,3,'Software Engineer','3','FULL_TIME_PERMANENT',1003,DATE '2021-03-01');
INSERT INTO emp_job (emp_id,dept_id,job_title,grade,employment_type,manager_emp_id,effective_date)
  VALUES (1006,4,'Finance Analyst','3','FULL_TIME_PERMANENT',1002,DATE '2022-01-10');
INSERT INTO emp_job (emp_id,dept_id,job_title,grade,employment_type,manager_emp_id,effective_date)
  VALUES (1007,5,'Operations Manager','6','FULL_TIME_PERMANENT',1001,DATE '2016-05-01');
INSERT INTO emp_job (emp_id,dept_id,job_title,grade,employment_type,manager_emp_id,effective_date)
  VALUES (1008,3,'Junior Software Developer','2','FULL_TIME_PERMANENT',1003,DATE '2025-01-15');
INSERT INTO emp_job (emp_id,dept_id,job_title,grade,employment_type,manager_emp_id,effective_date)
  VALUES (1009,2,'HR Coordinator','2','FULL_TIME_PERMANENT',1004,DATE '2023-02-01');
INSERT INTO emp_job (emp_id,dept_id,job_title,grade,employment_type,manager_emp_id,effective_date)
  VALUES (1010,6,'Marketing Executive','3','FULL_TIME_PERMANENT',1002,DATE '2024-06-01');
...
DECLARE
  ...
  TYPE t_bas IS TABLE OF NUMBER;
  ids  t_id  := t_id (1001,1002,1003,1004,1005,1006,1007,1008,1009,1010);
  bsals t_bas := t_bas(650000,450000,220000,160000,120000,120000,300000,80000,80000,120000);
  g    VARCHAR2(5);
  trp  NUMBER; mel NUMBER; mob NUMBER;
  epf_ee NUMBER; epf_er NUMBER; etf NUMBER; tax NUMBER;
  gross NUMBER; net NUMBER;
  cum_ee NUMBER; cum_er NUMBER; cum_et NUMBER;
  months NUMBER := 3;
BEGIN
  FOR i IN 1..ids.COUNT LOOP
    ...
    FOR m IN 1..months LOOP
      epf_ee := ROUND(bsals(i)*0.08,2);
      epf_er := ROUND(bsals(i)*0.12,2);
      etf    := ROUND(bsals(i)*0.03,2);
      tax    := CASE WHEN bsals(i)>=500000 THEN ROUND(bsals(i)*0.24,2)
                     WHEN bsals(i)>=300000 THEN ROUND(bsals(i)*0.18,2)
                     WHEN bsals(i)>=150000 THEN ROUND(bsals(i)*0.06,2)
                     ELSE 0 END;
...
-- ── LEAVE_BALANCE 2026 ────────────────────────────────────────────────────────
-- Entitlements based on years-of-service brackets per LEAVE-001 policy.
-- Kamal (7 yrs) = 21 days, Tharindu (4 yrs) = 17, Nethmi (2 yrs) = 14, etc.
...
-- no leave_balance rows for 1008
...
INSERT INTO leave_request (emp_id,leave_type,start_date,end_date,days_count,reason,status,approver_emp_id,approved_at)
  VALUES (1003,'ANNUAL',DATE '2025-01-06',DATE '2025-01-10',5,'Family vacation',
    'TAKEN',1001,TIMESTAMP '2024-12-20 10:00:00');
INSERT INTO leave_request (emp_id,leave_type,start_date,end_date,days_count,reason,status,approver_emp_id,approved_at)
  VALUES (1003,'SICK',DATE '2025-02-12',DATE '2025-02-14',3,'Flu',
...
INSERT INTO leave_request (emp_id,leave_type,start_date,end_date,days_count,reason,status)
  VALUES (1003,'ANNUAL',DATE '2025-06-16',DATE '2025-06-17',2,'Personal',
    'PENDING');

-- Tharindu: taken March, sick April, pending July
INSERT INTO leave_request (emp_id,leave_type,start_date,end_date,days_count,reason,status,approver_emp_id,approved_at)
  VALUES (1005,'ANNUAL',DATE '2025-03-17',DATE '2025-03-21',5,'New Year trip',
    'TAKEN',1003,TIMESTAMP '2025-03-10 09:00:00');
INSERT INTO leave_request (emp_id,leave_type,start_date,end_date,days_count,reason,status,approver_emp_id,approved_at)
  VALUES (1005,'SICK',DATE '2025-04-02',DATE '2025-04-04',3,'Dengue',
    'TAKEN',1003,TIMESTAMP '2025-04-02 07:00:00');
INSERT INTO leave_request (emp_id,leave_type,start_date,end_date,days_count,reason,status,approver_emp_id,approved_at)
  VALUES (1005,'SICK',DATE '2025-04-07',DATE '2025-04-08',2,'Extended recovery',
    'TAKEN',1003,TIMESTAMP '2025-04-07 07:00:00');
INSERT INTO leave_request (emp_id,leave_type,start_date,end_date,days_count,reason,status)
  VALUES (1005,'ANNUAL',DATE '2025-07-07',DATE '2025-07-09',3,'Trip','PENDING');

-- Sanduni: approved July leave
INSERT INTO leave_request (emp_id,leave_type,start_date,end_date,days_count,reason,status,approver_emp_id,approved_at)
  VALUES (1006,'ANNUAL',DATE '2025-07-14',DATE '2025-07-18',5,'Annual leave',
...
INSERT INTO training (emp_id,course_name,provider,completion_date,cert_name,cert_expiry,ld_spend,year,status)
  VALUES (1003,'AWS Solutions Architect Professional','AWS',DATE '2022-08-15',
    'AWS Certified Solutions Architect Professional',DATE '2025-08-15',85000,2022,'COMPLETED');
INSERT INTO training (emp_id,course_name,provider,completion_date,ld_spend,year,status)
  VALUES (1003,'System Design Masterclass','Educative.io',DATE '2024-07-31',12000,2024,'COMPLETED');
INSERT INTO training (emp_id,course_name,provider,completion_date,ld_spend,year,status)
  VALUES (1003,'Tech Leaders Summit 2025','SLT Innovation',DATE '2025-02-21',35000,2025,'COMPLETED');

-- Dilini: SHRM cert active
INSERT INTO training (emp_id,course_name,provider,completion_date,cert_name,cert_expiry,ld_spend,year,status)
  VALUES (1004,'SHRM-CP Certification','SHRM',DATE '2024-06-30',
    'SHRM Certified Professional',DATE '2027-06-30',95000,2024,'COMPLETED');
INSERT INTO training (emp_id,course_name,provider,completion_date,ld_spend,year,status)
  VALUES (1004,'HR Analytics with Power BI','DataCamp',DATE '2025-03-31',22000,2025,'COMPLETED');

-- Tharindu: basic online course
INSERT INTO training (emp_id,course_name,provider,completion_date,ld_spend,year,status)
  VALUES (1005,'Docker & Kubernetes Fundamentals','Udemy',DATE '2025-02-28',8500,2025,'COMPLETED');

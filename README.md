...
|---|---|---|
| [SAP Client](./sap_client/README.md) | REST API facade over SAP ECC (RFC/IDoc) and SAP S/4HANA OData | REST API |
| [HR Chat Assistant](./hr_chat_assistant/README.md) | AI-powered conversational agent for HR queries | REST API |
| [HubSpot to Oracle DB](./hubspot_to_oracledb/README.md) | Syncs HubSpot contact lifecycle events to Oracle DB | Event-driven (Webhook) |
| [MCP Server](./mcp_server/README.md) | Structured HR data provider for AI agents via MCP protocol | MCP Server |
| [RAG Ingestion](./rag_ingestion/README.md) | Ingests HR policy documents from SharePoint into Pinecone | Automation |
| [SAP ECC Events](./sap_ecc_events/README.md) | Inbound IDoc and RFC listener for SAP ECC | Event-driven (JCo) |

## Infrastructure

| Component | Description |
|---|---|
| [Fluent Bit](./fluent-bit/README.md) | Log aggregation and metrics forwarding to OpenSearch |
| `oracle-db/` | Oracle Database setup scripts for HR data |
| `postgres-db/` | PostgreSQL setup scripts |
| `hr-chat-ui/` | Frontend UI for the HR Chat Assistant |
...
1. [SAP Client](./sap_client/README.md)
2. [HR Chat Assistant](./hr_chat_assistant/README.md)
3. [HubSpot to Oracle DB](./hubspot_to_oracledb/README.md)
4. [MCP Server](./mcp_server/README.md)
5. [RAG Ingestion](./rag_ingestion/README.md)
6. [SAP ECC Events](./sap_ecc_events/README.md)
7. [Fluent Bit](./fluent-bit/README.md)
